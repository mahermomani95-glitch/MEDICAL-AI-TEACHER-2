...
assert.deepEqual(config.scenes.map(scene => scene.name), ["QUESTION","ANSWER_PROPOSAL","CLINICAL_REASONING","DISTRACTORS","EXAM_TRAP","TAKE_HOME"]);
assert.deepEqual(config.characters.map(character => character.id), ["MAHER","DR_ANAS","TEACHER"]);
